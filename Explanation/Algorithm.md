...
2.الگوریتم Lasso (خط آبی): مدل ساده‌تر و انعطاف‌پذیر، بهترین عملکرد (خطای تست ۲.۲۷) → انتخاب ویژگی هوشمند

3.الگوریتم Ridge (خط قرمز): عملکرد متوسط (خطای تست ۲.۸۲) → تعادل محافظه‌کارانه
